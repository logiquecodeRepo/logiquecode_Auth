...
const CreateUser = () => {
  ...
  const projectUrls = {
    lms: import.meta.env.VITE_LMS_SERVER_URL,
    dpms: import.meta.env.VITE_DPMS_SERVER_URL,
  };
  ...
  //       ? [...prevState.project, value] // Checkbox checked hone par add karega
  //       : prevState.project.filter((proj) => proj !== value); // Unchecked hone par remove karega
 ...
 const handleCheckboxChange = (e) => {
   ...
   setFormData((prevState) => {
     const updatedProjects = checked
       ? [...prevState.project, { name: value, serverUrl: projectUrls[value] }]
       : prevState.project.filter((proj) => proj.name !== value);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/users/createUser`, {
        ...
        // body: JSON.stringify(formDataToSend), // Sending FormData
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 items-center">
            ...
            {/* <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none text-lg"
              >
                <option value="" disabled className="text-lg font-bold">
                  Select Project
                </option>
              ...
              <div className="flex space-x-6">
                ...
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    className="w-5 h-5 text-blue-500 border-gray-300 rounded focus:ring-blue-500"
                  />
                  <span className="text-lg font-bold">DPMS</span>
                </label>
              </div>
            </div>
          </div>
